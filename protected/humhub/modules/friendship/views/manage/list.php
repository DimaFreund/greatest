...
<div class="content-wrap">
    <div class="personal-profile-friends">
        <?php if($receivedRequestsCount) { ?>
            <div class="title"><?= Yii::t('base','Requests'); ?></div>
            <div class="friends-header">
                <div class="stat"><?= $receivedRequestsCount; ?> <?= Yii::t('base','Requests'); ?></div>
            </div>
            ...
            <ul id="list-object" class="friends-list">
	            <?php foreach($requests as $friend) { ?>
                    <li class="friend">
                        ...
                        <ul class="menu">
                            <div class="btn-block">
                                <div class="base-sm-btn"><?= Html::a(Yii::t('base','Accept'), ['/friendship/request/add', 'userId' => $friend->id], ['class' => '', 'data-method' => 'POST']); ?></div>
                                <div class="base-sm-btn"><?= Html::a(Yii::t('base','Reject'), ['/friendship/request/delete', 'userId' => $friend->id], ['class' => '', 'data-method' => 'POST']); ?></div>
                            </div>
                        </ul>
                    </li>
	            <?php } ?>
        ...
        <div class="title"><?= Yii::t('base','Friends'); ?></div>
        <div class="friends-header">
            <div class="stat"><?= $count; ?> <?= Yii::t('base','Friends'); ?><span style="display: none;">(12 mutual)<?php //TODO add mutual friend count and mutal list friend ?></span></div>
